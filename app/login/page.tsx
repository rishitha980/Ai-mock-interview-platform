...
import { Eye, EyeOff, Bot, Check, Sparkles } from "lucide-react";
...
export default function LoginPage() {
  ...
  const hasGoogleClientId = !!rawClientId;
  const isPlaceholder =
    !rawClientId ||
    rawClientId.includes("YOUR_GOOGLE_CLIENT_ID") ||
    rawClientId.includes("123456789-");
    ...
    <div className="flex min-h-screen w-full bg-[#0B0F1A]">
      ...
      <div className="hidden lg:flex lg:w-[45%] xl:w-[42%] flex-col justify-between relative overflow-hidden p-10 xl:p-14">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-3xl xl:text-4xl font-black text-white leading-tight mb-4">
            Prepare Smarter,<br />
            <span className="text-white/70">Get Hired Faster</span>
          </h2>
          <p className="text-sm text-white/60 leading-relaxed max-w-sm">
            Join thousands of professionals who used AI Mock Interview to land their dream jobs.
          </p>
        </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-6 py-12 lg:px-12 xl:px-20">
        ...
        <div className="w-full max-w-[400px] space-y-7">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white placeholder-slate-500 outline-none transition-all focus:border-[#6C47FF]/60 focus:ring-2 focus:ring-[#6C47FF]/20 focus:bg-white/8"
              />
            </div>
            ...
            <div>
              ...
              <div className="flex justify-end mt-1.5">
                <a href="#" className="text-xs font-semibold text-[#6C47FF] hover:text-[#A78BFA] transition-colors">
                  Forgot Password?
                </a>
              </div>
            </div>
          ...
          {hasGoogleClientId && !isPlaceholder ? (
            ...
            <div className="rounded-xl border border-amber-500/20 bg-amber-500/10 p-4 text-xs text-amber-400 space-y-1.5">
              <p className="font-bold flex items-center gap-1.5">
                ⚠️ Google Sign-In Config Required
              </p>
          ...
          <p className="text-center text-sm text-slate-400">
            ...
            <Link href="/signup" className="font-bold text-[#6C47FF] hover:text-[#A78BFA] transition-colors">
              Sign up free
            </Link>
          </p>
        </div>
